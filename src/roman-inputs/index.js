...
import romanConverter from '../util/roman-converter'
...
return(
    <Container>
                ...
                <Col md={6} xs={12}>
                    <Form.Group controlId="formBasicEmail">
                        ...
                        <Form.Control 
                            ...
                            value={firstValue}
                            type="number"
                            onChange={e => handleValueChange('firstNumber', +e.target.value, setFirstValue, setErrorField)}
                        />
                        {errorField === 'firstNumber' && <ErrorMessage>value exceeded allowable range (0-99999)</ErrorMessage>}
                ...
                <Col md={6} xs={12}>
                    <Form.Group controlId="formBasicEmail">
                        ...
                        <Form.Control 
                            ...
                            value={secondValue}
                            type="number"
                            onChange={e => handleValueChange('secondNumber', +e.target.value, setSecondeValue, setErrorField)}
                          />
                        {errorField === 'secondNumber' && <ErrorMessage>value exceeded allowable range (0-99999)</ErrorMessage>}
                        <RomanValue className="text-muted">
            ...
            <ButtonsRow>
                <Col md={4} xs={12}>
                    <CustomBtn variant="primary" onClick={calculateTotal}>Add Them</CustomBtn>
                </Col>
                <Col md={4} xs={12}>
                    <CustomBtn variant="warning" onClick={calculatemulti}>Multi Them</CustomBtn>
                </Col>
                <Col md={4} xs={12}>
                    <CustomBtn variant="danger" onClick={calculateSub}>Sub Them</CustomBtn>
                </Col>
            </ButtonsRow>
            <Row>
                <Col xs={12}>
                    <Result>Result: <span>{total}</span></Result>
                </Col>
                 <Col xs={12}>
                    <Result>Result In Roman: 
